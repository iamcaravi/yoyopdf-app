const tool = (name, icon = 'tools', tone = 'red') => Object.freeze({ name, icon, tone, status: 'planned' });

export const TOOL_CATEGORIES = Object.freeze([
  { name: 'Organize PDF', tools: [tool('Merge PDF', 'merge'), tool('Split PDF', 'split'), tool('Reorder Pages'), tool('Delete Pages'), tool('Extract Pages'), tool('Rotate PDF')] },
