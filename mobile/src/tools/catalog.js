...
export const TOOL_CATEGORIES = Object.freeze([
  { name: 'Organize PDF', tools: [tool('Merge PDF', 'merge', 'red', 'available', '#/tools/merge'), tool('Split PDF', 'split', 'red', 'available', '#/tools/split'), tool('Reorder Pages', 'tools', 'red', 'available', '#/tools/reorder'), tool('Delete Pages', 'tools', 'red', 'available', '#/tools/delete'), tool('Extract Pages'), tool('Rotate PDF')] },
